...
/**
 * Represents a Rock Paper Scissors game where players can play against each other. Implements the
 * Minigame interface for game lifecycle management.
 */
public class RockPaperScissorsGame implements Minigame {
  private final GameConfig config;

  /**
   * Constructs a new Rock Paper Scissors game with the specified configuration.
   *
   * @param config the game configuration
   */
  public RockPaperScissorsGame(GameConfig config) {
    this.config = config;
  }
