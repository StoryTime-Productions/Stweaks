...
/**
 * Represents a Guess Who game where players guess the identity of a character based on yes/no
 * questions. Implements the Minigame interface for game lifecycle management.
 */
public class GuessWhoGame implements Minigame {
  private final GameConfig config;

  /**
   * Constructs a new Guess Who game with the specified configuration.
   *
   * @param config the game configuration
   */
  public GuessWhoGame(GameConfig config) {
    this.config = config;
  }
