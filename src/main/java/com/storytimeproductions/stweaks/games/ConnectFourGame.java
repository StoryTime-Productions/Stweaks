...
/**
 * Represents a Connect Four game where players take turns dropping colored discs into a vertical
 * grid. Implements the Minigame interface for game lifecycle management.
 */
public class ConnectFourGame implements Minigame {
  private final GameConfig config;

  /**
   * Constructs a new Connect Four game with the specified configuration.
   *
   * @param config the game configuration
   */
  public ConnectFourGame(GameConfig config) {
    this.config = config;
  }
