...
/**
 * Represents a Sumo Wrestling game where players can compete in a sumo wrestling match. Implements
 * the Minigame interface for game lifecycle management.
 */
public class SumoWrestlingGame implements Minigame {
  private final GameConfig config;

  /**
   * Constructs a new Sumo Wrestling game with the specified configuration.
   *
   * @param config the game configuration
   */
  public SumoWrestlingGame(GameConfig config) {
    this.config = config;
  }
